...
all_colors = []
for ii in range(22):
    all_colors += d3["Category20"][20] + d3["Category20b"][20] + d3["Category20c"][20]


def viz_results_paper(
    gt, pred, name="test", pred_prob=None, pred_actsig=None, pred_prob_actsig=None
):
    fr_width = 30
    height = 420
    ...
    palette = [
        (0.9, 0.9, 0.9),
        sns.color_palette("colorblind", 10)[0],
    ]  # deep, muted, pastel, bright, dark, colorblind
    palette2 = [
        (0.9, 0.9, 0.9),
        sns.color_palette("pastel", 10)[0],
    ]  # deep, muted, pastel, bright, dark, colorblind
    ...
    for ix, item in enumerate(gt):
        ...
        image[
            20:200,
            fr_width * (ix + 1) + shift : fr_width * (ix + 1) + shift - 1 + fr_width,
        ] = color
